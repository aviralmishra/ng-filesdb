...
gulp.task('inject', ['jscode', 'wiredep', 'styles', 'templatecache'], function () {
...
function startBrowserSync(isDev, specRunner) {
  ...
  if (isDev) {
    gulp.watch([config.less, config.js, config.html, config.temp], ['styles', 'inject'])
